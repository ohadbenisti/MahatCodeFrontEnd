      ...
      <div className="edit-question-inner">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <label
              htmlFor="year"
              className="edit-question-form-group mx-1 pt-2"
            >
              שנה{" "}
            </label>
            <select
            ...
            <label htmlFor="season" className="edit-question-form-group mx-1">
              עונה{" "}
            </label>
            <select
              name="Season"
            ...
            <label
              htmlFor="seasonNum"
              className="edit-question-form-group mx-1"
            >
              מועד{" "}
            </label>
            <select
              ...
              value={testSeasonNum ? testSeasonNum : ""}
            >
              <option value=""></option>
            ...
            <br />
            <label
              htmlFor="partOfTheTest"
              className="edit-question-form-group mx-1 pt-3"
            >
              חלק{" "}
            </label>
            <select
              ...
              value={partOfTheTest ? partOfTheTest : ""}
            >
              <option value=""></option>
              <option value="א">א</option>
              <option value="ב">ב</option>
            ...
            <label
              ...
              className="edit-question-form-group mx-2"
            >
              מספר שאלה{" "}
            </label>
            <select
              ...
              value={numberOfQuestion ? numberOfQuestion : ""}
            >
              <option value=""></option>
