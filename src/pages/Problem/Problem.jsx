...
const Problem = ({ courseQuestion, courseDetails, onRightAnswer }) => {
  ...
  return (
    <div className="problem-container bg-white p-4 rounded shadow-md mb-4">
      {isAdmin && (
        <div className="flex-col justify-start space-x-2 mb-2 gap-1">
          <button className="editBtn mb-1" onClick={handleEditClick}>
          ...
          <button className="bin-button deleteBtn" onClick={handleDeleteClick}>
